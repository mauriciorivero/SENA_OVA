...
document.getElementById("btn_ejercicio5").onclick = function (){
    var editable1 = document.getElementById("ej5_ed1").value;
    var editable2 = document.getElementById("ej5_ed2").value;
    var editable3 = document.getElementById("ej5_ed3").value;
    if((editable1!="")&&(editable2!="")&&(editable3!="")){
        if((editable1==="1")&&(editable2==="1")&&(editable3==="4")){
            SetResultsColor("ok", "ej5");
            mostrarSiguiente();
        }else{
            SetResultsColor("wrong", "ej5");
            ocultarSiguiente();
        }
    }
}