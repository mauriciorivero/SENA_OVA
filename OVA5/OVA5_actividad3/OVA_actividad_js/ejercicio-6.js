...
document.getElementById("btn_ejercicio6").onclick = function (){
    var editable1 = document.getElementById("ej6_ed1").value;
    var editable2 = document.getElementById("ej6_ed2").value;
    var editable3 = document.getElementById("ej6_ed3").value;
    if((editable1!="")&&(editable2!="")&&(editable3!="")){
        if((editable1==="3.2")&&(editable2==="3")&&(editable3==="8")){
            SetResultsColor("ok", "ej6");
            mostrarSiguiente();
        }else{
            SetResultsColor("wrong", "ej6");
            ocultarSiguiente();
        }
    }
}