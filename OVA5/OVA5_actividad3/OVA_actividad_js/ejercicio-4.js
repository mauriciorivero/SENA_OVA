...
document.getElementById("btn_ejercicio4").onclick = function (){
    var editable1 = document.getElementById("ej4_ed1").value;
    var editable2 = document.getElementById("ej4_ed2").value;
    var editable3 = document.getElementById("ej4_ed3").value;
    if((editable1!="")&&(editable2!="")&&(editable3!="")){
        if((editable1==="1.07")&&(editable2==="3")&&(editable3==="8")){
            SetResultsColor("ok", "ej4");
            mostrarSiguiente();
        }else{
            SetResultsColor("wrong", "ej4");
            ocultarSiguiente();
        }
    }
}